...
def main(args):
    ...
    optimizer = optim.AdamW(params=pg, lr=args.lr, weight_decay=args.wd)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./convnext_tiny_1k_224_ema.pth', help='initial weights path')
    parser.add_argument('--freeze-layers', type=bool, default=False)
    parser.add_argument('--device', default='mps', help='device id (i.e. 0 or 1, or cpu')
