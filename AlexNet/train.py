...
def main(args):
    ...
    # if there exists pre-trian weight, load it
...
if __name__=='__main__':
    ...
    parser.add_argument('--data-path', type=str, default='/Users/chengshengdeng/Documents/MachineLearning/DeepLearning/Pytorchlearning/'
                                'deep-learning-for-image-processing-master/data_set/flower_data/flower_photos')


    # download model weights
    # parser.add_argument('--weights', type=str, default='./alexnet.pth', help='initial weights path')
